...
try
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Hospital Bed API", Version = "v1" });
    ...
    Log.Information("BedService starting up");
    app.Run();

}
catch (Exception ex)
{
    Log.Fatal(ex, "BedService terminated unexpectedly");
}
finally
{
    Log.CloseAndFlush();
