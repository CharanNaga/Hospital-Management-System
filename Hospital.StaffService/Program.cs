...
try
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Hospital Staff API", Version = "v1" });
    ...
    Log.Information("StaffService starting up");
    app.Run();

}
catch (Exception ex)
{
    Log.Fatal(ex, "StaffService terminated unexpectedly");
}
finally
{
    Log.CloseAndFlush();
